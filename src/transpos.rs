use crate::types::{BitBoard, ChessMove, HashKey, MegaBytes, Score, SearchDepth, EMPTY_CHESS_MOVE};
...
impl TranspositionTable {
    ...
    pub fn re_size(&mut self, new_size_mb: MegaBytes) {
        ...
        self.table.resize(new_size, EMPTY_TABLE_ENTRY);
    ...
    pub fn set(&mut self, new_entry: &TableEntry) {
        let entry = &mut self.table[new_entry.key & self.mod_base];
