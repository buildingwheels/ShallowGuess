...
macro_rules! generate_legal_attacks_from_move_mask {
    ($chess_position: expr, $attack_square:expr, $move_mask:expr, $chess_moves:expr) => {
        process_occupied_indices!($move_mask, |next_from_square| {
            ...
            if !is_in_check($chess_position, $chess_position.player ^ BLACK) {
...
macro_rules! generate_legal_white_promotions_from_move_mask {
    ($chess_position: expr, $attack_square:expr, $move_mask:expr, $chess_moves:expr) => {
        process_occupied_indices!($move_mask, |next_from_square| {
            let chess_move = ChessMove {
                from_square: next_from_square,
...
macro_rules! generate_legal_black_promotions_from_move_mask {
    ($chess_position: expr, $attack_square:expr, $move_mask:expr, $chess_moves:expr) => {
        process_occupied_indices!($move_mask, |next_from_square| {
            let chess_move = ChessMove {
                from_square: next_from_square,
...
pub fn get_least_valued_attackers_to_chess_square(
    ...
    if chess_position.player == WHITE {
        ...
        if pawn_attack_mask != 0 {
            if get_rank(chess_square) == RANK_8 {
                generate_legal_white_promotions_from_move_mask!(
                    chess_position,
                    chess_square,
                    pawn_attack_mask,
                    &mut attacker_moves
                ...
                generate_legal_attacks_from_move_mask!(
                    chess_position,
                    chess_square,
                    pawn_attack_mask,
                    &mut attacker_moves
        ...
        if pawn_attack_mask != 0 {
            if get_rank(chess_square) == RANK_1 {
                generate_legal_black_promotions_from_move_mask!(
                    chess_position,
                    chess_square,
                    pawn_attack_mask,
                    &mut attacker_moves
