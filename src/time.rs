...
pub fn calculate_optimal_time_for_next_move(time_control: &TimeInfo) -> MilliSeconds {
    ...
    time_control.remaining_time_millis / remaining_move_count as MilliSeconds
        + time_control.increment_time_millis / INCREMENT_TIME_BUFFER_RATIO
}
